...
public class ClientBox extends javax.swing.JFrame implements Serializable {
    ...
    private void btnConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConnectActionPerformed
        ...
        if(clientThread == null){
            try{
                 if(txtHostIP.getText().isEmpty()){
                        JOptionPane.showMessageDialog(null,"Host IP is empty","Message",JOptionPane.ERROR_MESSAGE);
                        return;
                  }
                 if(txtPort.getText().isEmpty()){
                        JOptionPane.showMessageDialog(null,"Post is empty","Message",JOptionPane.ERROR_MESSAGE);
                        return;
                 }
                 if(txtUsername.getText().isEmpty()){
                        JOptionPane.showMessageDialog(null,"Username is empty","Message",JOptionPane.ERROR_MESSAGE);
                        return;
                 }
                ...
                lblStatus.setText("Conneted to server");
